...
class DateTimeCompareValidator extends Validator {
	 ...
	 * <li>'>=': validates to see if the value being validated is greater than or equal to the value being compared
	 * with;</li>
	 * <li>'<': validates to see if the value being validated is less than the value being compared with;</li>
	 * <li>'<=': validates to see if the value being validated is less than or equal to the value being compared
	 * with.</li>
	 * </ul>
	 */
	public $operator = '=';
